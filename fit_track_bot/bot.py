...
class FitTrackBot:
    ...
    def _get_welcome_message(self) -> str:
        ...
        return (
            ...
            'Например:\n'
            'UserProfile пол "мужской" age 25 height 180.5 ...'
        )
    ...
    def _get_help_message(self) -> str:
        ...
        return (
            ...
            '   Обязательные свойства: пол, age, height, weight, goal, activity_type\n'
            '   Пример: UserProfile пол "мужской" age 25 height 180.5 weight 75.0 '
            'goal "похудение" activity_type "средняя"\n\n'
            '2. Exercise - Упражнение\n'
            '   Обязательные свойства: name, sets, reps_per_set, weight\n'
            '   Пример: Exercise name "Приседания" sets 4 reps_per_set 10 weight 60.0\n\n'
            '3. Workout - Тренировка\n'
            '   Обязательные свойства: date, duration\n'
            '   Пример: Workout date 2025.12.15 duration 01:30\n\n'
            '4. NutritionGoal - Цель питания\n'
            '   Обязательные свойства: goal_type, calories, protein, fat, carbs\n'
            '   Пример: NutritionGoal goal_type "похудение" calories 1800.0 '
            'protein 120.0 fat 50.0 carbs 180.0\n\n'
